...
\]
\emph{Intrinsic value} is the payoff if the option were exercised now; \emph{time value} is the extra worth from the chance of moving (further) into the money before $T$. It decays to $0$ as $t\to T$ (``time decay''); at maturity $C_T$ equals the intrinsic value.
\begin{center}
\begin{tikzpicture}
